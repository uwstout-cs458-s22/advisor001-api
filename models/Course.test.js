...
describe('Course Model', () => {
  ...
  describe('Adding Course', () => {
    ...
    test('Inputting duplicate course', async () => {
      ...
      console.log(randomCourse.courseId, ' ', typeof randomCourse.courseId);
      console.log(
        randomCourse.department,
        ' ',
        typeof randomCourse.department,
        ' ',
        typeof randomCourse.department === 'string'
      );
      console.log(typeof randomCourse.department);
      console.log(typeof randomCourse.number);
      console.log(typeof randomCourse.id);
      console.log(typeof randomCourse.credits);
